...
class ListUtils {
  ...
  static Widget buildDataTable<T>(
    ...
    Color headingRowTextColor = Colors.redAccent,
    Color headingRowIconColor = Colors.redAccent,
    ...
    return _dataTable<T>(
      ...
      headingRowHeight: headingRowHeight,
      headingRowColor: headingRowColor,
      headingRowTextColor: headingRowTextColor,
      headingRowIconColor: headingRowIconColor,
      columnTextFontSize: columnTextFontSize,
      columnTextBold: columnTextBold,
      columnSpacing: columnSpacing,
  ...
  static Widget _dataTable<T>(
    ...
    return isScrollable
        ...
        : SizedBox(width: MediaQuery.of(context).size.width, child: _table);
  }

  static String _getValue(Map<String, dynamic> _mapRep, String propertyName) {
